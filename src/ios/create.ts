...
target '${appName}' do
  ...
  pod 'Lynx', '~> 3.4.0-rc.0', :subspecs => [
    'Framework',
  ]
  pod 'PrimJS', '~> 2.14.0-rc.1', :subspecs => ['quickjs', 'napi']
  pod 'LynxService', '~> 3.4.0-rc.0', :subspecs => [
      'Image',
      'Log',
      'Http',
  ]
...
/* Begin PBXFileReference section */
		...
		${ids.infoPlistRef} /* Info.plist */ = {isa = PBXFileReference; lastKnownFileType = text.plist.xml; path = "Info.plist"; sourceTree = "<group>"; };
